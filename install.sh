...
wget -O config.json https://raw.githubusercontent.com/nyeinkokoaung404/google-idx/refs/heads/main/xray-config-template.json
...
wget https://raw.githubusercontent.com/nyeinkokoaung404/google-idx/refs/heads/main/startup.sh
